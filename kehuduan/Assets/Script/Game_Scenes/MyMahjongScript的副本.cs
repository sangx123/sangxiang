...
public class MyMahjongScript1 : MonoBehaviour
{
	...
	private List<List<GameObject>> PengGangCardList; //自己的碰杠牌组
	private List<List<GameObject>> PengGangList_L;   //左边的碰杠牌组
	private List<List<GameObject>> PengGangList_T;   //上边的碰杠牌组
	private List<List<GameObject>> PengGangList_R;   //右边的碰杠牌组

 ...
 */
public class MotionVdaOptionAdapter extends BaseAdapter implements SpinnerAdapter {
  private String[] items;
  private Context mContext;

  public MotionVdaOptionAdapter(Context ctx) {
    items = ctx.getResources().getStringArray(R.array.motion_detection_vda);
    mContext = ctx;
  }

...
public class CrystalRangeSeekbar extends View {
    ...
    protected int getBarHighlightColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_highlight_color, getResources().getColor(R.color.text_blue));
    }

    protected int getLeftThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_left_thumb_color, getResources().getColor(R.color.text_blue));
    }

    protected int getRightThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_right_thumb_color, getResources().getColor(R.color.text_blue));
    }

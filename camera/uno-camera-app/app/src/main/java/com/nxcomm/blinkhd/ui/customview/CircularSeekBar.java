...
public class CircularSeekBar extends View {
  ...
  private void initAttributes(TypedArray attrArray) {
    ...
    mMax = attrArray.getInt(R.styleable.CircularSeekBar_maximum, DEFAULT_MAX);
    mProgress = attrArray.getInt(R.styleable.CircularSeekBar_current_progress, DEFAULT_PROGRESS);

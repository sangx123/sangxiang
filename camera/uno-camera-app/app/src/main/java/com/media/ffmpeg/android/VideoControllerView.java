...
public class VideoControllerView extends FrameLayout {
  ...
  private void initControllerView(View v) {
    ...
    if (mProgress != null) {
      if (mProgress instanceof SeekBar) {
        ...
        if (hideThumb) {
          Log.d(TAG, "Hide controller seek bar successful");
          performHideThumb();
        }
      }
  ...
  public void setPlaybackFinished(boolean isFinished) {
    isPlaybackFinished = isFinished;
  }

  private int setProgress() {
    if (mPlayer == null || mDragging || isPlaybackFinished) {
      return 0;
    }
  ...
  public int setProgressCompleted() {
    int position = mDuration;
  ...
  public void updateFullScreen() {
    ...
    if (mPlayer.isFullScreen()) {
      mFullscreenButton.setImageResource(R.drawable.video_min);
    } else {
      mFullscreenButton.setImageResource(R.drawable.video_max);
    }
  ...
  public void hideThumb() {
    if (mProgress != null) {
      Log.d(TAG, "Hide controller successful");
      performHideThumb();
    } else {
      Log.d(TAG, "Media controller is not initialized yet");
      hideThumb = true;
    }
  }

  private void performHideThumb() {
    ((SeekBar) mProgress).setThumb(null);
    mProgress.setEnabled(false);
    mProgress.getLayoutParams().height = (int) (getResources().getDisplayMetrics().density * 4);
  }

...
public class CameraAccessPointListAdapter extends BaseAdapter {
  ...
  public CameraAccessPointListAdapter(Context c, List<ApScanBase> ap_list) {
    mContext = c;
    this.apList = ap_list;
  }
  ...
  public View getView(int position, View convertView, ViewGroup arg2) {
    ...
    if (convertView == null) { // if it's not recycled, initialize some attributes
      ...
      listItemHolder = (LinearLayout) inflater.inflate(R.layout.bb_access_point_list_item, null);
    } else {

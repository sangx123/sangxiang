...
class StandardShowcaseDrawer implements ShowcaseDrawer {
    ...
    @Override
    public void setShowcaseWidth(int width) {
    }
    ...
    @Override
    public void setShowcaseHeight(int height) {
    }
    ...
    @Override
    public void setBlockedRadius(float radius) {
    }
    ...
    public void drawShowcase(Bitmap buffer, float x, float y, float scaleMultiplier) {
        ...
        int top = (int) (y - halfH);
        showcaseDrawable.setBounds(left, top, left + getShowcaseWidth(),

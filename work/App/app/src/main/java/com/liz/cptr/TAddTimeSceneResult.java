...
public class TAddTimeSceneResult { 
	...
	public static final Enum FAILED_OVER_MAX_COUNT = Enum.forString("failed_over_max_count");
	...
	public static final int INT_FAILED_OVER_MAX_COUNT = 7;
	...
	static final public class Enum extends StringEnumTable {
		...
		public static Enum forInt(int i) {
			...
			case INT_FAILED_OVER_MAX_COUNT:
				return FAILED_OVER_MAX_COUNT;
		...
		public static final Table table = new Table(
				new Enum[] {
					...
					new Enum("failed_over_max_count", INT_FAILED_OVER_MAX_COUNT),

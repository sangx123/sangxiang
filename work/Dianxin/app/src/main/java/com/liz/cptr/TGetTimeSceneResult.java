...
public class TGetTimeSceneResult { 
	...
	public static final Enum FAILED_NO_DATA_AVAIABLE = Enum.forString("failed_no_data_avaiable");
	...
	public static final int INT_FAILED_NO_DATA_AVAIABLE = 6;
	...
	static final public class Enum extends StringEnumTable {
		...
		public static Enum forInt(int i) {
			...
			case INT_FAILED_NO_DATA_AVAIABLE:
				return FAILED_NO_DATA_AVAIABLE;
			default:
				return null;
			}
		}
		...
		public static final Table table = new Table(
				new Enum[] {
					...
					new Enum("failed_no_data_avaiable", INT_FAILED_NO_DATA_AVAIABLE),
				}
		);

...
public class TUserLoginResult { 
	...
	public static final Enum FAILED_PASSWORD_ERROR = Enum.forString("failed_password_error");
	...
	public static final int INT_FAILED_PASSWORD_ERROR = 6;
	...
	static final public class Enum extends StringEnumTable {
		...
		public static Enum forInt(int i) {
			...
			case INT_FAILED_PASSWORD_ERROR:
				return FAILED_PASSWORD_ERROR;
			default:
				return null;
			}
		}
		...
		public static final Table table = new Table(
				new Enum[] {
					...
					new Enum("failed_password_error", INT_FAILED_PASSWORD_ERROR),
				}
		);

...
public class TDelPhonebooksResult { 
	...
	public static final Enum FAILED_PHONE_NUMBER_NOT_EXISTED = Enum.forString("failed_phone_number_not_existed");
	...
	public static final int INT_FAILED_PHONE_NUMBER_NOT_EXISTED = 6;
	...
	static final public class Enum extends StringEnumTable {
		...
		public static Enum forInt(int i) {
			...
			case INT_FAILED_PHONE_NUMBER_NOT_EXISTED:
				return FAILED_PHONE_NUMBER_NOT_EXISTED;
			default:
				return null;
			}
		}
		...
		public static final Table table = new Table(
				new Enum[] {
					...
					new Enum("failed_phone_number_not_existed", INT_FAILED_PHONE_NUMBER_NOT_EXISTED),
				}
		);

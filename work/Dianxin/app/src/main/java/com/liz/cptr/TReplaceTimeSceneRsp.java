...
public class TReplaceTimeSceneRsp extends SeqidPacket { 

	com.liz.cptr.TReplaceTimeSceneResult.Enum result;
	...
	private TReplaceTimeSceneRsp() {

	}

	public static class Factory {
		static public TReplaceTimeSceneRsp newInstance() {
			return new TReplaceTimeSceneRsp();
		}
	}


	static public TReplaceTimeSceneRsp parse(SimpleXmlParse parse) throws XmlParseException, Exception{
		
		TReplaceTimeSceneRsp packet = new TReplaceTimeSceneRsp();
		String name;
		...
		packet.result = com.liz.cptr.TReplaceTimeSceneResult.Enum.parse(parse.takeValue());
	...
	public String getXmlTagName() {
		return com.liz.cptr.CptRPacketParse.REPLACE_TIME_SCENE_RSP;
	}
	public com.liz.cptr.TReplaceTimeSceneResult.Enum getResult() {
		return result;
	}

	public void setResult(com.liz.cptr.TReplaceTimeSceneResult.Enum result) {
		this.result = result;
	}

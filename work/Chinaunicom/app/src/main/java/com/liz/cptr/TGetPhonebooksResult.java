...
public class TGetPhonebooksResult { 
	...
	public static final Enum FAILED_NO_PHONE_NUMBER = Enum.forString("failed_no_phone_number");
	...
	public static final int INT_FAILED_NO_PHONE_NUMBER = 6;
	...
	static final public class Enum extends StringEnumTable {
		...
		public static Enum forInt(int i) {
			...
			case INT_FAILED_NO_PHONE_NUMBER:
				return FAILED_NO_PHONE_NUMBER;
			default:
				return null;
			}
		}
		...
		public static final Table table = new Table(
				new Enum[] {
					...
					new Enum("failed_no_phone_number", INT_FAILED_NO_PHONE_NUMBER),
				}
		);
